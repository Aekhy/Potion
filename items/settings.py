...
INGREDIENT_DATA = Read("items/ingredients.json")
# -- characteristics --
# used
HOT = "chaud"
COLD = "froid"
...
BASE_ACTIVE_COMPATIBILITY_MATRIX = Read("items/base_active_compatibility_matrix.json")
...
BASE_GRAPH = Read("items/base_graph.json")
...
ACTIVE_GRAPH = Read("items/active_graph.json")
...
ALCHEMICAL_PROPERTY_MATRIX = Read("items/alchemical_property_matrix.json")
